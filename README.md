...
Production dataset preprocessing/sharding, a production training executable, true tensor mini-batching, mixed precision, CUDA, instruction tuning, and conversational tuning are not implemented. Real-corpus convergence, Arabic model capability, and English model capability have not been demonstrated.
